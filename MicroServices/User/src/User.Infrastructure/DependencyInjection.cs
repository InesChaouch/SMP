...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("SMPDb");
        Guard.Against.Null(connectionString, message: "Connection string 'SMPDb' not found.");
        ...
        // Register LinkedInSettings config here
